...
function ProtectedView() {
  ...
  return (
    <div className="flex items-center justify-center w-screen h-screen p-4 bg-yellow-500">
      <div className="flex flex-col items-center justify-center gap-8">
        <div className="flex flex-wrap items-end justify-center px-4 mb-4 space-x-2 ">
          <span className="text-2xl font-thin text-center text-black sm:text-3xl">
            Country
          </span>
          <span className="text-lg italic font-thin text-center text-black sm:text-xl">
            n'
          </span>
          <span className="text-2xl font-bold text-center text-black sm:text-3xl">
            Currency
          </span>
        </div>
        <span className="font-thin text-gray-400 text-8xl">
          <svg
            width="52"
            height="52"
            viewBox="0 0 15 15"
